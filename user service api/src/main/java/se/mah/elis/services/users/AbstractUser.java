...
public interface AbstractUser {
	 ...
	 * 
	 * <p>getProperties() and getPropertiesTemplate() MUST present their keys
	 * in the same order, or the storage engine will fail in some cases, E.G.
	 * if the underlying storage implementation don't deal with keys and values
	 * in a good manner.</p>
	 * 
	 * <p>Three fields are mandatory for every user property presentation.
	 * Those three are:</p>
	 * 
	 * <ul>
	 *   <li>uuid - A UUID object</li>
	 *   <li>service_name - A string, see getServiceName().</li>
	 *   <li>created - A Joda DateTime object, see created().</li>
	 * </ul>
	 * 
	...
	/**
	 * Gets the service name associated with the user type. This has to match
	 * the service name given by the user recipe's service name (see
	 * UserRecipe#getServiceName()).
	 * 
