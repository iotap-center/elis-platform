...
public class MockDataObject3Provider implements DataObjectProvider {

	public MockDataObject3Provider() {
	...
	public ElisDataObject build(Properties properties)
		...
		ElisDataObject mdo = new MockDataObject3();
	...
	public DataObjectRecipe getRecipe() {
		return new MockDataObject3Recipe();
	}
